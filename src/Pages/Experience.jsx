...
const Experience = () => {
  return (
    <div id='experience'>
        <motion.h3 variants={fadeIn('down',0.2)} initial="hidden" whileInView="show" viewport={{once:false,amount:0}} className='text-white w-full text-5xl font-medium text-center mt-30 lg:mt-35'>Experience </motion.h3>
